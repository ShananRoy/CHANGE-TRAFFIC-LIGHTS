...
def semantic_lidar_data1(point_cloud_data):
    ...
    for detection in point_cloud_data:
        ...
        if distance_name_data['name'] == 'Pedestrains' and distance_name_data["distance"] > 1 and distance_name_data["distance"] < 8:
...
def car_control():
    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.51, steer=0.2))
    time.sleep(20)
